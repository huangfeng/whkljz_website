...
gulp.task "webpack-dev-server", (callback) ->
  # Ensure there's a `./public/assets/css/style.css` file that can be required.
  touch.sync('./' + paths.css + '/style.css', time: new Date(0))
...
gulp.task 'build', ['webpack:build', 'css', 'copy-assets-ignore-html', 'bower-copy', 'minify-html']
